  ...
  <header class="masthead">
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        <h1 class="mx-auto my-0 text-uppercase">PLANES SIN DINERO BAQ</h1>
        <h2 class="text-white-50 mx-auto mt-2 mb-5">Descubre qué hacer cuando no tienes ni un peso</h2>
...
//obtencion de datos de la tabla
    ...
    die("Connection failed: " . mysqli_connect_error());
        ...
        <?php
	$sql = "SELECT l.* FROM lugaresbaq l join categorias c on l.nombre=c.nombre WHERE c.".$tipo."='1' and c.sinDinero='1' ";
